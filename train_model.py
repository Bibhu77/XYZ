...
def train_model():
    ...
    X = data[['is_compatible', 'distance', 'hospital_distance', 'urgency', 'reliability']]
    y = data['match_quality']
    
    # Scale distance-based features
    scaler = StandardScaler()
    X[['distance', 'hospital_distance']] = scaler.fit_transform(X[['distance', 'hospital_distance']])
